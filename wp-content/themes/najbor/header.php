...
<div class="menu inactive">
    ...
    <ul class="menu__list hidden categories">
		...
		?>
        <li class='menu__item animate cursor--img item' data-thumbnail='<?php echo get_template_directory_uri().'/assets/images/main-thumb.jpg' ?>'><a href='<?php echo $home."/prace" ?>'><?php echo $labels["wszystkie"][$lang]?></a></li>
    </ul>
